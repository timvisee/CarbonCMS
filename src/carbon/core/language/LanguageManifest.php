...
use carbon\core\exception\language\manifest\LanguageManifestLoadException;
...
*@param string $file File to load the language manifest from.
     ...
     *
*@throws LanguageManifestLoadException Throws exception if failed to load the language manifest and
    ...
    public static function loadManifest($file, $throw_exception = true) {
        ...
        if(!file_exists($file)) {
            if($throw_exception)
                throw new LanguageManifestLoadException(

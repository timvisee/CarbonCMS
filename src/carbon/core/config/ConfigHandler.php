...
use carbon\core\exception\config\ConfigException;
use carbon\core\exception\config\ConfigLoadException;
...
class ConfigHandler {
     ...
     *
     * @throws ConfigException Throws exception when the configuration array is invalid and $throw_exception equals to true
